      ...
      <div className="container mx-auto px-6 lg:px-8 py-16">
        ...
        <div className="grid lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed max-w-md">
              병원 운영의 디지털 전환을 선도하는 SaaS
              플랫폼입니다. 의료진이 환자에게 더 집중할 수 있는
              환경을 만들어갑니다.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-gray-300">
                ...
                <span className="text-sm">070-5047-4420</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-300">
                <Mail className="w-4 h-4 text-blue-400 flex-shrink-0" />
                <span className="text-sm">
                  smclinic@easymedi.co.kr
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          ...
          <div className="text-xs text-gray-500">
            <p>
              사업자등록번호: 718-01-01669 | 대표: 조석만 |
              통신판매신고: 2020-화성동탄-0712
            </p>
            <p className="mt-2">
              본 사이트는 병원 관리 솔루션 정보 제공을 목적으로
              하며, 의료진의 진료를 대체할 수 없습니다.
            </p>
          </div>
        </div>
      </div>
